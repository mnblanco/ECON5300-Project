...
ggplot(ss16ppr,  aes(RACWHT, WAGP)) +
  geom_boxplot() +
  theme_minimal() +
  stat_summary(fun.data = fun_mean, geom="text", vjust=-0.7, size=3)
```
...
ggplot(ss16ppr,  aes(RACBLK, WAGP)) +
  geom_boxplot() +
  theme_minimal() +
  stat_summary(fun.data = fun_mean, geom="text", vjust=-0.7, size=3)
```
...
ggplot(ss16ppr,  aes(RACHISP, WAGP)) +
  geom_boxplot() +
  theme_minimal() +
  stat_summary(fun.data = fun_mean, geom="text", vjust=-0.7, size=3)
```
...
+ Correlation is 0.2348 
    ...
    + The relation is likely to be significant
