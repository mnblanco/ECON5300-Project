...
+ Coefficients Explanation 
    + Holding gender, race, education and age constant, married people makes $`r abs(round(Model_1$coefficients["Widowed"], 2))` more than people who widowed on average.
...
+ Coefficients Explanation 
    ...
    + Holding gender, race, education and age constant, married people makes $`r round((exp(LogModel_1$coefficients["Widowed"]) -1) * 100, 2)`% more than people who widowed on average.
